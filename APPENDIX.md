# 📚 KotlinCookBook - Complete Recipe Appendix
...
| `BasicFuncion.kt` | [🔗 Code](https://github.com/realmg51-cpu/KotlinCookBook/blob/main/src/kotlin/normal/Funcions/BasicFuncions/BasicFuncion.kt) | [📖 Intro](https://github.com/realmg51-cpu/KotlinCookBook/blob/main/src/kotlin/normal/Funcions/BasicFuncions/introduction.md) |
...
| `StringSplitter.kt` | [🔗 Code](https://github.com/realmg51-cpu/KotlinCookBook/blob/main/src/kotlin/normal/Variables/WorkWithIt/StringSplitter.kt) | [📖 Intro](https://github.com/realmg51-cpu/KotlinCookBook/blob/main/src/kotlin/normal/Variables/WorkWithIt/introduction.md) |
...
|--------|-------|
| 🍳 **Total Recipes** | `15` |
| 📖 **With Introduction** | `15` |
| 🆕 **Last Updated** | 2026-04-24 11:05:22 UTC |

---

> *"Bookmark this page - it's your complete Kotlin recipe collection!"* 🚀